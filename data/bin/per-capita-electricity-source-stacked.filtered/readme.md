...
This data package contains the data that powers the chart ["Per capita electricity generation by source"](https://ourworldindata.org/grapher/per-capita-electricity-source-stacked?country=OWID_WRL~CHN~IND~USA~JPN~DEU~GBR~BRA~FRA~CAN~SWE~ZAF~AUS&v=1&csvType=filtered&useColumnShortNames=false) on the Our World in Data website.
...
## Electricity generation from bioenergy per person – Ember
Measured in [kilowatt-hours](#dod:watt-hours) per person.
Last updated: April 24, 2026  
Next update: April 2027  
Date range: 1985–2025  
...
#### Full citation
Ember (2026); Population based on various sources (2024) – with major processing by Our World in Data. “Electricity generation from bioenergy per person – Ember” [dataset]. Ember, “Yearly Electricity Data Europe”; Ember, “Yearly Electricity Data”; Various sources, “Population” [original data].
Source: Ember (2026), Population based on various sources (2024) – with major processing by Our World In Data
...
## Electricity generation from other renewables, excluding bioenergy, per person – Ember
Measured in [kilowatt-hours](#dod:watt-hours) per person.
Last updated: April 24, 2026  
Next update: April 2027  
Date range: 1985–2025  
...
#### Full citation
Ember (2026); Population based on various sources (2024) – with major processing by Our World in Data. “Electricity generation from other renewables, excluding bioenergy, per person – Ember” [dataset]. Ember, “Yearly Electricity Data Europe”; Ember, “Yearly Electricity Data”; Various sources, “Population” [original data].
Source: Ember (2026), Population based on various sources (2024) – with major processing by Our World In Data
