# Per capita electricity generation from fossil fuels, nuclear and renewables - Data package

This data package contains the data that powers the chart ["Per capita electricity generation from fossil fuels, nuclear and renewables"](https://ourworldindata.org/grapher/per-capita-electricity-fossil-nuclear-renewables?country=OWID_WRL~CHN~IND~USA~GBR~FRA~AUS~SWE~ZAF~JPN~BRA&v=1&csvType=filtered&useColumnShortNames=false) on the Our World in Data website.
...
## Electricity generation from fossil fuels per person – Ember
Electricity generation from coal, oil, and gas, measured in [kilowatt-hours](#dod:watt-hours) per person.
...
#### Full citation
Ember (2026); Energy Institute - Statistical Review of World Energy (2025); Population based on various sources (2024) – with major processing by Our World in Data. “Electricity generation from fossil fuels per person – Ember” [dataset]. Ember, “Yearly Electricity Data Europe”; Ember, “Yearly Electricity Data”; Energy Institute, “Statistical Review of World Energy”; Various sources, “Population” [original data].
Source: Ember (2026), Energy Institute - Statistical Review of World Energy (2025), Population based on various sources (2024) – with major processing by Our World In Data
...
## Electricity generation from renewables per person – Ember
Measured in [kilowatt-hours](#dod:watt-hours) per person.
Last updated: April 24, 2026  
Next update: April 2027  
Date range: 1985–2025  
...
#### Full citation
Ember (2026); Energy Institute - Statistical Review of World Energy (2025); Population based on various sources (2024) – with major processing by Our World in Data. “Electricity generation from renewables per person – Ember” [dataset]. Ember, “Yearly Electricity Data Europe”; Ember, “Yearly Electricity Data”; Energy Institute, “Statistical Review of World Energy”; Various sources, “Population” [original data].
Source: Ember (2026), Energy Institute - Statistical Review of World Energy (2025), Population based on various sources (2024) – with major processing by Our World In Data
