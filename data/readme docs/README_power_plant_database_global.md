...
Dataset Modification Note (FIT2179 A2):

The file `power_plant_database_global.csv` in this repository is a reduced version of the original dataset.
All columns to the right of `primary_fuel` have been removed to reduce file size for use on GitHub Pages.
...
The following columns from the original dataset were removed: `other_fuel1`, `other_fuel2`, `other_fuel3`, `commissioning_year`, `owner`, `source`, `url`, `geolocation_source`, `wepp_id`, `year_of_capacity_data`, `generation_gwh_2013`–`generation_gwh_2019`, `generation_data_source`, `estimated_generation_gwh_2013`–`estimated_generation_gwh_2017`, `estimated_generation_note_2013`–`estimated_generation_note_2017`.
