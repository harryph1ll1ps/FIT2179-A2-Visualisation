...
This data package contains the data that powers the chart ["Per capita electricity generation from fossil fuels, nuclear and renewables"](https://ourworldindata.org/grapher/per-capita-electricity-fossil-nuclear-renewables?country=CHN~IND~USA~GBR~FRA~AUS~SWE~ZAF~JPN&v=1&csvType=filtered&useColumnShortNames=false) on the Our World in Data website.
